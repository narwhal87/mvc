...
/**
 * Test class for class DeckBJ
 */
class DeckBJTest extends TestCase {
    ...
    public function testCreateDeck() {
        $this->assertInstanceOf("\App\Card\DeckBJ", $this->deck);
    }

    public function testGetSize() {
        $this->assertEquals($this->deck->getSizeOfDeck(), 4 * 52);
    }
    ...
    public function testDeckDrawEmpty() {
        ...
        $this->assertEquals($this->deck->getSizeOfDeck(), 4 * 52 - 1);
    }
    ...
    public function testDeckDrawMany() {
        ...
        $this->assertInstanceOf("\App\Card\Card", array_pop($cards));
        $this->assertEquals($this->deck->getSizeOfDeck(), 4 * 52 - $num);
    }
